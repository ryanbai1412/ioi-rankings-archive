...
export function round_to_str(value, ndigits) {
    if (ndigits > 0) {
...
export default new function () {
    ...
    self.init_contests = function () {
        {
            const data = window.data.contests;
            for (var key in data) {
        ...
        // });
        {
            self.asset_config = window.data.asset_config;
        }
        // $.ajax({
    ...
    self.init_stats = function () {
        ...
        //     },
        //     error: function () {
        //         console.error("Error while getting the IOI stats data");
        //     }
        // });
    };
